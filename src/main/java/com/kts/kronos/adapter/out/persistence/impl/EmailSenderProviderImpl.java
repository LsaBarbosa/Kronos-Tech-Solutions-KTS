        ...
        try {
            ...
            var htmlText = String.format(
                    "!DOCTYPE html>" +
                            ...
                            // CONTAINER PRINCIPAL (para centralizar e dar um 'corpo' ao email)
                            ...
                            // FALLBACK (Se o botão não funcionar)
                            ...
                            // INFORMAÇÃO DE EXPIRAÇÃO (ALERTA EM LARANJA/VERMELHO)
                            ...
                            // CLÁUSULA DE SEGURANÇA (Verde-escuro para tranquilizar)
